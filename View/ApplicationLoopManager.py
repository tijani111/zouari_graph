...
class ApplicationLoopManager:
    ...
    def __init__(self, component_provider: IComponentProvider):
        ...
        self.graph_visualizer_controller = component_provider.get_graph_visualizer_controller()
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.button == 3:  # Right Click
                        ...
                        self.graph_visualizer.handle_legend_click(event.pos)
                ...
                if pygame.mouse.get_pressed()[0] and start_node_drag:
                    ...
                    start_node_drag = (mouse_x, mouse_y)
                    self.graph_visualizer_controller.move_selected_node_subtree(self.selected_node_container.selected_node, dx, dy)
