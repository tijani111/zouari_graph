...
class IGraphVisualizer(ABC):
    ...
    def set_similarity_edges_rendering(self, active: bool):
        """
        Sets if the visibility of the similarity edges should be rendered.
        :param: active: True = rendered
        """

    @abstractmethod
    def get_similarity_edges_rendering_state(self):
        """
        Gets the current state of the rendering of the similarity_edges.
        """

    @abstractmethod
    def set_connection_edges_rendering(self, active: bool):
        """
        Sets if the connection edges should be drawn.
        :param: active: True = rendered
        """
    ...
    def get_connection_edges_rendering_state(self):
        """
        Gets the current state of the rendering of the regular connections_edges.
        :return: visibility state: true = is drawn false = not drawn
        """

    @abstractmethod
    def set_node_color_based_on_type(self):
        """
        Sets the node colors based on the node type.
        """