...
class NodeDetailsWindow(INodeDetailsWindow):
    ...
    def __init__(self, window_width, window_height, screen, ui_theme: UITheme,
        ...
        """
        self.markdown_text_renderer = markdown_text_renderer
        ...
        self.node_details_background_surface = pygame.Surface((self.node_details_background_width,
                                                              ...
                                                              pygame.SRCALPHA)
        self.node_details_background_surface.fill(ui_theme.NODE_DETAILS_WINDOW_BACKGROUND_COLOR)
    ...
    def show_node_details(self):
        ...
        if content_height >= self.node_details_background_height:
            ...
            self.text_area_scroll_manager.draw_scrollbar(self.window_width, self.NODE_DETAILS_X_PADDING,
                                                         ...
                                                         self.screen, self.ui_theme.MAIN_MENU_HIGHLIGHT_COLOR)
    ...
    def __display_image_area(self, x_pos, y_pos, image_area_width, image_area_height, x_padding, y_padding, image_path):
        if isinstance(self.selected_node_container.selected_node, NodeIllustration):
            ...
            # Prüfen, ob das Bild existiert, andernfalls den Pfad auf einen Platzhalter setzen
            if not os.path.isfile(full_path):
                full_path = os.path.join(image_path, "image_placeholder.png")
            ...
            image_area_render_surface = pygame.Surface((image_area_width, image_area_height), pygame.SRCALPHA)
            image_area_render_surface.fill(self.ui_theme.NODE_DETAILS_WINDOW_CONTENT_AREA_BACKGROUND)
    ...
    def __display_titel_area(self, x_pos, y_pos, titel_area_width, x_padding, y_padding):
        ...
        titel_area_render_surface = pygame.Surface((titel_area_width, calculated_titel_area_height), pygame.SRCALPHA)
        # Rendern des Texts auf dem separaten Surface
        titel_area_render_surface.fill(self.ui_theme.NODE_DETAILS_WINDOW_CONTENT_AREA_BACKGROUND)
    ...
    def __display_text_area_markdown(self, x_pos, y_pos, text_area_width, image_and_titel_area_height,
        ...
        if isinstance(self.selected_node_container.selected_node, NodeKnowledge):
            if self.selected_node_container.selected_node is not None and self.re_rendering_required:
                ...
                self.max_content_height += self.max_content_height * 0.05  # Threshold for size calculation
                ...
                self.text_area_render_surface = pygame.Surface((text_area_width, max_text_height), pygame.SRCALPHA)

                # Rendern des Texts auf dem separaten Surface
                self.text_area_render_surface.fill(self.ui_theme.NODE_DETAILS_WINDOW_CONTENT_AREA_BACKGROUND)
